...
const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(`https://chirkut-server.vercel.app/api/v2/auth/register`, newUser);
  ...
  return (
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center">
              <div className="flex flex-col justify-center items-center w-96 h-96   p-4  profile-left-1">
                   <h1 className="text-2xl text-white mb-4 montserrat-alternates-bold">চিরকুট</h1>
                  <Link to="/login">
